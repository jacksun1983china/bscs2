 ...
 * 兼容处理：为部分浏览器底部工具栏预留安全区，避免图标与文字被遮挡
 */
...
const navItemRaise = q(10);
const hallIconTop = q(-47);
  ...
  return (
    <div
      style={{
        ...
        width: '100%',
        zIndex: 100,
        paddingBottom: `calc(env(safe-area-inset-bottom, 0px) + ${q(10)})`,
        background: 'linear-gradient(180deg, rgba(17,7,42,0) 0%, rgba(10,4,30,0.92) 36%, rgba(10,4,30,0.98) 100%)',
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            transform: `translateY(-${navItemRaise})`,
          }}
        >
        ...
        <img
          ...
          onClick={() => go('/')}
          style={{
            position: 'absolute', left: q(300), top: hallIconTop,

/**
 * ArenaIntroAnimation.tsx — 竞技场开场动画（简洁版）
 *
 * 流程：
 *   0.05s — 左右头像从两侧飞入
 *   0.9s  — VS 文字弹出 + 霓虹光效
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 2,
            marginTop: 8,
            background: 'linear-gradient(90deg, rgba(192,132,252,0.8), rgba(34,211,238,0.8))',
